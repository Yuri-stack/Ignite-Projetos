...
export default function Product({ product }: ProductProps) {
    ...
    const itemAlreadyInCart = checkIfProductAlreadyInCart(product.id)

    // Essa lógica foi sobrescrita durante o desafio, mas deixarei devido a prática de estudo
        ...
        <>
            ...
            <ProductContainer>
                ...
                <ProductDetails>
                    ...
                    >
                        { itemAlreadyInCart ? 'Produto já adicionado' : 'Colocar na sacola' }
                    </button>
                </ProductDetails>
            </ProductContainer>
        </>
